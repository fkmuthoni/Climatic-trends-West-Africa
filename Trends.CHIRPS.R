...
normalityTest(Trend ~ mergeID2, test = "ad.test", data = chirps.wa.signdf.long)

##Test for homogeneity of variances


bartlett.test(Trend ~ mergeID2, data = chirps.wa.signdf.long) # var1 != varN

##bcnPower transformation to normality
chirpsWa.powerTransform = powerTransform(Trend ~ mergeID2, data = chirps.wa.signdf.long, family = "bcnPower")

chirps.wa.friedman = friedman.test(Trend~Month |AEZ, data=chirps.wa.signdf.long)

####Kruskal.test ####

chirps.Kruskal = kruskal.test(Trend ~ mergeID2, data = chirps.wa.signdf.long)

####Post-hoc testNemenyi.test####

chirps.nemenyi = posthoc.kruskal.nemenyi.test(Trend ~ mergeID2, data = chirps.wa.signdf.long, dist="Chisquare", p.adjust.method="bonferroni")

#####...........................................................................Comparison of Cooling n wetting trends..........................................................................................................####
...
####ggplot
Eco2 = ggplot(chirps.wa.signdf.long, aes(AEZ, Trend, fill= Month)) +  
  geom_point(outlier.size = 1, width=0.5) + 
  labs(x="Crops", y= "Benefits (USD/ha)", fill = "Treatments") +
  theme_bw(base_size = 12) + 
  theme(legend.position = "none") +
  #geom_signif(y_position=c(37000,37000), xmin=c(0.8, 1.8), xmax=c(1.2, 2.2), annotation=c("***", "***"), tip_length=0) +
  #scale_fill_manual(values = c("grey80", "grey40")) + 
  theme(panel.grid.major.x = element_line(size = NA) )
...
with(chirps.wa.signdf.long, mean.plot(x.factor = AEZ, trace.factor = Month, response = Trend))

##Histogram of group lattice
lattice::histogram(~ Trend | mergeID2, data=chirps.wa.signdf.long,layout=c(9,6)) 
